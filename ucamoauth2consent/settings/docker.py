...
# Debug-related functionality is only enabled if the UCAM_CONSENT_ENABLE_DEBUG_THIS_IS_DANGEROUS
# environment variable is set and is non-empty.
DEBUG = os.environ.get('UCAM_CONSENT_ENABLE_DEBUG_THIS_IS_DANGEROUS', '') != ''
